...
export default function LoginPage(): React.ReactElement {
  ...
  const handleSubmit = async (e: React.FormEvent): Promise<void> => {
    ...
    setIsLoading(true);
    try {
      // API call would go here via React Query mutation
  ...
  return (
    <div style={styles.container}>
      ...
      <form onSubmit={handleSubmit} style={styles.form}>
        ...
        <button type="submit" disabled={isLoading} style={styles.button} data-testid="login-submit">
      ...
      <p style={styles.footer}>
        {t('auth.noAccount')}{' '}
        <a href="/register" style={styles.link}>{t('auth.signUp')}</a>
      </p>
    </div>
  );
}
